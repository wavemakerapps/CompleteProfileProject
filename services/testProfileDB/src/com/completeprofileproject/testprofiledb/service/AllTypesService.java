...
public interface AllTypesService {
     ...
     */
    AllTypes getById(Integer alltypesId);
	...
	/**
     * Find and return the list of AllTypes by given id's.
     *
     ...
     *
     * @param alltypesIds The id's of the AllTypes to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return AllTypes associated with the given alltypesIds.
     */
    List<AllTypes> findByMultipleIds(List<Integer> alltypesIds, boolean orderedReturn);
     ...
     */
    AllTypes delete(Integer alltypesId);
