...
public class AllTypesServiceImpl implements AllTypesService {
    ...
    public AllTypes partialUpdate(Integer alltypesId, Map<String, Object>allTypesPatch) {
        ...
        try {
            ObjectReader allTypesReader = this.objectMapper.readerForUpdating(allTypes);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service testProfileDB for table AllTypes to {} format", options.getExportType());
