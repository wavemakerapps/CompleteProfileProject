...
public class SaleServiceImpl implements SaleService {
    ...
    @Transactional(value = "testProfileDBTransactionManager")
    @Override
    public Sale partialUpdate(Integer saleId, Map<String, Object>salePatch) {
        LOGGER.debug("Partially Updating the Sale with id: {}", saleId);

        Sale sale = getById(saleId);

        try {
            ObjectReader saleReader = this.objectMapper.readerForUpdating(sale);
            sale = saleReader.readValue(this.objectMapper.writeValueAsString(salePatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", salePatch, ex);
