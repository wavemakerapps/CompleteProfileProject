...
import com.completeprofileproject.testprofiledb.service.SaleService;
 ...
 * @see Sale
 */
@RestController("testProfileDB.SaleController")
@Api(value = "SaleController", description = "Exposes APIs to work with Sale resource.")
@RequestMapping("/testProfileDB/Sale")
public class SaleController {

    private static final Logger LOGGER = LoggerFactory.getLogger(SaleController.class);

    @Autowired
	@Qualifier("testProfileDB.SaleService")
    ...
    @ApiOperation(value = "Partially updates the Sale instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Sale patchSale(@PathVariable("id") Integer id, @RequestBody @MapTo(Sale.class) Map<String, Object> salePatch) {
        LOGGER.debug("Partially updating Sale with id: {}" , id);

        Sale sale = saleService.partialUpdate(id, salePatch);
        LOGGER.debug("Sale details after partial update: {}" , sale);
