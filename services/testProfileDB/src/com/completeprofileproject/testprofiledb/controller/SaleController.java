...
public class SaleController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Sale getSale(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Sale editSale(@PathVariable("id") Integer id, @RequestBody Sale sale) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSale(@PathVariable("id") Integer id) throws EntityNotFoundException {
