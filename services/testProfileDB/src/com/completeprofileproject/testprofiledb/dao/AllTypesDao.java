...
package com.completeprofileproject.testprofiledb.dao;
 ...
 */
@Repository("testProfileDB.AllTypesDao")
public class AllTypesDao extends WMGenericDaoImpl<AllTypes, Integer> {

    @Autowired
    @Qualifier("testProfileDBTemplate")
    private HibernateTemplate template;

    @Autowired
    @Qualifier("testProfileDBWMQLTypeHelper")
