...
public class Table8Controller {
    ...
    @ApiOperation(value = "Partially updates the Table8 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table8 patchTable8(@PathVariable("id") Integer id, @RequestBody @MapTo(Table8.class) Map<String, Object> table8Patch) {
        LOGGER.debug("Partially updating Table8 with id: {}" , id);

        Table8 table8 = table8Service.partialUpdate(id, table8Patch);
        LOGGER.debug("Table8 details after partial update: {}" , table8);
