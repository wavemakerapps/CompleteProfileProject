...
import com.completeprofileproject.sales.VenueDetail;
import com.completeprofileproject.sales.service.VenueDetailService;
...
public class VenueDetailController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VenueDetail getVenueDetail(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VenueDetail editVenueDetail(@PathVariable("id") Integer id, @RequestBody VenueDetail venueDetail) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVenueDetail(@PathVariable("id") Integer id) throws EntityNotFoundException {
