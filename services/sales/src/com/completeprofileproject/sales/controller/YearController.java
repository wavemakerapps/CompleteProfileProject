...
import com.completeprofileproject.sales.service.YearService;
...
public class YearController {
    ...
    @ApiOperation(value = "Partially updates the Year instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Year patchYear(@PathVariable("id") Integer id, @RequestBody @MapTo(Year.class) Map<String, Object> yearPatch) {
        LOGGER.debug("Partially updating Year with id: {}" , id);

        Year year = yearService.partialUpdate(id, yearPatch);
        LOGGER.debug("Year details after partial update: {}" , year);
