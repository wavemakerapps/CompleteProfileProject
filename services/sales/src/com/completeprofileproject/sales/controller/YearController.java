...
public class YearController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Year getYear(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Year editYear(@PathVariable("id") Integer id, @RequestBody Year year) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteYear(@PathVariable("id") Integer id) throws EntityNotFoundException {
