...
import com.completeprofileproject.sales.service.ActionItemService;
...
public class ActionItemController {
    ...
    @ApiOperation(value = "Partially updates the ActionItem instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ActionItem patchActionItem(@PathVariable("id") Integer id, @RequestBody @MapTo(ActionItem.class) Map<String, Object> actionItemPatch) {
        LOGGER.debug("Partially updating ActionItem with id: {}" , id);

        ActionItem actionItem = actionItemService.partialUpdate(id, actionItemPatch);
        LOGGER.debug("ActionItem details after partial update: {}" , actionItem);
