...
public class ActionItemController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ActionItem getActionItem(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ActionItem editActionItem(@PathVariable("id") Integer id, @RequestBody ActionItem actionItem) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteActionItem(@PathVariable("id") Integer id) throws EntityNotFoundException {
