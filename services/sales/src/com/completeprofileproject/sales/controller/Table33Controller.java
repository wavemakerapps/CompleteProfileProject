...
public class Table33Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table33 getTable33(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table33 editTable33(@PathVariable("id") Integer id, @RequestBody Table33 table33) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable33(@PathVariable("id") Integer id) throws EntityNotFoundException {
