...
public class ClientController {
    ...
    @ApiOperation(value = "Partially updates the Client instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Client patchClient(@PathVariable("id") Integer id, @RequestBody @MapTo(Client.class) Map<String, Object> clientPatch) {
        LOGGER.debug("Partially updating Client with id: {}" , id);

        Client client = clientService.partialUpdate(id, clientPatch);
        LOGGER.debug("Client details after partial update: {}" , client);
