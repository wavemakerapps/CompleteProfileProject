...
public class ClientController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Client getClient(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Client editClient(@PathVariable("id") Integer id, @RequestBody Client client) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteClient(@PathVariable("id") Integer id) throws EntityNotFoundException {
