...
public class ActionItemServiceImpl implements ActionItemService {
    ...
    @Transactional(value = "salesTransactionManager")
    @Override
    public ActionItem partialUpdate(Integer actionitemId, Map<String, Object>actionItemPatch) {
        LOGGER.debug("Partially Updating the ActionItem with id: {}", actionitemId);

        ActionItem actionItem = getById(actionitemId);

        try {
            ObjectReader actionItemReader = this.objectMapper.readerForUpdating(actionItem);
            actionItem = actionItemReader.readValue(this.objectMapper.writeValueAsString(actionItemPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", actionItemPatch, ex);
    ...
    public ActionItem delete(Integer actionitemId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), ActionItem.class.getSimpleName(), actionitemId);
        }
