...
public class ClientServiceImpl implements ClientService {
    ...
    @Transactional(value = "salesTransactionManager")
    @Override
    public Client partialUpdate(Integer clientId, Map<String, Object>clientPatch) {
        LOGGER.debug("Partially Updating the Client with id: {}", clientId);

        Client client = getById(clientId);

        try {
            ObjectReader clientReader = this.objectMapper.readerForUpdating(client);
            client = clientReader.readValue(this.objectMapper.writeValueAsString(clientPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", clientPatch, ex);
