...
public class ProductcatalogServiceImpl implements ProductcatalogService {
    ...
    @Transactional(value = "salesTransactionManager")
    @Override
    public Productcatalog partialUpdate(Integer productcatalogId, Map<String, Object>productcatalogPatch) {
        LOGGER.debug("Partially Updating the Productcatalog with id: {}", productcatalogId);

        Productcatalog productcatalog = getById(productcatalogId);

        try {
            ObjectReader productcatalogReader = this.objectMapper.readerForUpdating(productcatalog);
            productcatalog = productcatalogReader.readValue(this.objectMapper.writeValueAsString(productcatalogPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", productcatalogPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        productcatalog = update(productcatalog);
    ...
    public Productcatalog delete(Integer productcatalogId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Productcatalog.class.getSimpleName(), productcatalogId);
        }
