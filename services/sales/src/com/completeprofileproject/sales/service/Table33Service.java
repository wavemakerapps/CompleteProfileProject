...
public interface Table33Service {
     ...
     */
    Table33 getById(Integer table33Id);
	...
	/**
     * Find and return the list of Table33s by given id's.
     *
     ...
     *
     * @param table33Ids The id's of the Table33 to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Table33s associated with the given table33Ids.
     */
    List<Table33> findByMultipleIds(List<Integer> table33Ids, boolean orderedReturn);
     ...
     */
    Table33 delete(Integer table33Id);
